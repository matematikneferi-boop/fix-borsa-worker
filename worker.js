...
function tvkTeshisMetni(liste){
  ...
  /* 🔬 2026-09-06-e GEÇİCİ: hangi dalın neden seçildiğini tahmin etmek
     yerine HAM veriyi doğrudan gösteriyoruz — bu satır teşhis netleşince
     kaldırılacak. */
  var ham=" \n\n🔬 ham: calisiyor="+liste.calisiyor+" evrenSayisi="+liste.evrenSayisi+" yazmaHata="+(liste.yazmaHata||"yok")+" | "+
    liste.map(function(d){return d.tf+":sonTur="+(d.sonTur?JSON.stringify(d.sonTur):"null")}).join(" | ");
  return parcalar.join(" · ")+"."+not+ham;
}
