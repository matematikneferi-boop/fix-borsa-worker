...
function mbGoster(v,yerel){
  ...
  if(D.yon)
    h+='<div class="sirala" style="margin-top:6px">'+
       '<button class="sir" id="mbDur">'+(calisiyor?"⏸ Taramayı durdur":"▶️ Taramayı sürdür")+'</button></div>';
