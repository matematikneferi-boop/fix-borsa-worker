...
function u(e){
const t=[[{text:"🏅 Bu taramanın ilk 3'ü",callback_data:"ilk3"}],
[{text:"⚡ Kısa Trade (15DK)",callback_data:"tavan"}],[{text:"🪜 Kısa Trade adayları (Süper Üyelik)",callback_data:"adayKisa"}],
[{text:"📊 Orta Trade (1SA)",callback_data:"potansiyel"}],[{text:"🪜 Orta Trade adayları (Süper Üyelik)",callback_data:"adayOrta"}],
[{text:"📐 Orta Vade (4SA)",callback_data:"fibo"}],[{text:"🪜 Orta Vade adayları (Süper Üyelik)",callback_data:"adayOrtaVade"}],
[{text:"🗓 Uzun Vade (1G)",callback_data:"uzunvade"}],[{text:"🪜 Uzun Vade adayları (Süper Üyelik)",callback_data:"adayUzun"}],
...
const Q={tavan:"⚡ <b>KISA TRADE</b> · 15DK",potansiyel:"📊 <b>ORTA TRADE</b> · 1SA",fibo:"📐 <b>ORTA VADE</b> · 4SA",uzunvade:"🗓 <b>UZUN VADE</b> · 1G pivot kırılımı",adayKisa:"🪜 <b>KISA TRADE ADAYLARI</b>",adayOrta:"🪜 <b>ORTA TRADE ADAYLARI</b>",adayOrtaVade:"🪜 <b>ORTA VADE ADAYLARI</b>",adayUzun:"🪜 <b>UZUN VADE ADAYLARI</b>"};export default{async fetch(p,A,q){const $=new URL(p.url);if(n=$.origin,
